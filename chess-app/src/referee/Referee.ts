...
import { bishopMove, getPossiblePawnMoves, getPossibleKnightMoves, getPossibleBishopMoves, getPossibleRookMoves, kingMove, knightMove, pawnMove, queenMove, rookMove } from "./rules";
